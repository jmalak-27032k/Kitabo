...
export const ROUTES: RouteInfo[] = [
  ...
  // },
  {
    path: '/page/Home', title: 'Home', icon: 'ft-home', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/page/Favorite', title: 'Favorite', icon: 'fa fa-heart-o', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/page/Cart', title: 'Cart', icon: 'fa fa-shopping-cart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  }, {
    path: '/page/MyOrders', title: 'My Orders', icon: 'fa fa-shopping-bag', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },

  {
    path: '/page/Plan', title: 'Plan', icon: 'fa fa-list-ul', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
